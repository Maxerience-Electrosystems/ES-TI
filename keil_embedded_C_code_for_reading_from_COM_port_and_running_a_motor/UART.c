...
// as part of Lab 11, modify this program to use UART0 instead of UART1
  while((UART0_FR_R&UART_FR_RXFE) != 0); // Code loops in while itself as long as 1. The next command is executed when while goes to 0
...
//0x30 is added because numbers in ascii are represented as strings
unsigned char String[10];
unsigned char Data[6]; // 4-byte empty buffer
...
// as part of Lab 11 implement this function
  if(n>= 1000 && n<10000){
		...
		String[4] = 0x20;					// space character
		String[5] = 0;            // null termination
	}	
	else if(n>=100 && n<1000){
		String[0] = 0x20;					// thousands digit
		String[1] = n/100 + 0x30; // hundreds digit
		n = n%100;              	// n is now between 0 and 99
		String[2] = n/10 + 0x30;  // tens digit
		n = n%10;               	// n is now between 0 and 9
...
// as part of Lab 11 implement this function
  ...
  n = n%1000;                // 0 to 999
  String[1] = '.';
	String[2]= 0x30+n/100;    // hundreds digit
  n = n%100;                 // 0 to 99
	String[3] = n/10 + 0x30;  // tens digit
	n = n%10;                	// n is now between 0 and 9	
	String[4] = n+0x30; 		 // ones digit
	String[5] = 0x20;				 // space character
	String[6] = 0x63;					//c
	String[7] = 0x6d;					//m	
  String[8] = 0;		
	}
